...
export default function Header({ onOrderNow, showButton }: HeaderProps) {
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-primary text-primary-foreground transition-all duration-300">
      <div className="container flex h-auto flex-wrap items-center justify-between gap-y-2 p-2 sm:flex-nowrap sm:px-4 sm:py-2">
        ...
        <div className={cn(
          "flex w-full flex-grow-0 basis-full justify-center transition-opacity duration-300 sm:w-auto sm:basis-auto sm:justify-end",
          showButton ? "opacity-100" : "opacity-0 sm:opacity-100"
        )}>
          <Button
